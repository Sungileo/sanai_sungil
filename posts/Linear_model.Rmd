...
c <- plot_ly(y = data$station_m,type = "box",name = "근처 역 거리")
d <- plot_ly(y = data$pop,type = "box",name = "법정동 인구수")
e <- plot_ly(y = data$dong_area,type = "box",name = "법정동 크기")
f <- plot_ly(y = data$foreign_ratio,type = "box",name = "외국인 비율")
g <- plot_ly(y = data$school_m,type = "box",name = "근처 초등학교까지의 거리")
h <- plot_ly(y = data$market_m,type = "box",name = "근처 마트까지의 거리")

subplot(a,b,c,d,e,f,g,h, nrows = 3)
```

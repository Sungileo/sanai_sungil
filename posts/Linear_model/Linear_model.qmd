...
위 박스플롯을 기준으로 upper fence 밖에 있는 관측치 256건 제거
...
-   역까지의 거리, 초등학교까지의 거리의 p-value가 0.05 보다 크므로 유의하지 않다고 볼 수 있다.

-   R-squred 값이 0.6743으로 독립변수들이 종속변수(평당 금액)을 67% 정도 설명할 수 있음을 의미함
...
AIC 값으로 `근처 역까지의 거리(station_m)` 변수가 제거되었다.

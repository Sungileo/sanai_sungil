...
author: "Sungil Park"
date: "2023/11/29"
description: "딥러닝을 공부해보아요. / 인공지능 (2023-2)"
categories: python
---
...
```{r}
a <- read.csv("DL_final_proj_train_1.csv")
DT::datatable(head(a,20))
```
...
### fit model with earlystopping & Printdot method
...
```{python, eval = FALSE}
model.save("model_save_load_test", save_format="tf")
model = tf.keras.models.load_model("model_save_load_test")
model.summary()
```

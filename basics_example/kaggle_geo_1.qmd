...
```{python}
# Read in the data
full_data = gpd.read_file("/home/sungil/dataset/archive/DEC_lands/DEC_lands/DEC_lands.shp")
...
POI_data = gpd.read_file("/home/sungil/dataset/archive/DEC_pointsinterest/DEC_pointsinterest/Decptsofinterest.shp")

campsites = POI_data.loc[POI_data.ASSET=='PRIMITIVE CAMPSITE'].copy()

# Foot trails in New York state (LineString)
roads_trails = gpd.read_file("/home/sungil/dataset/archive/DEC_roadstrails/DEC_roadstrails/Decroadstrails.shp")

trails = roads_trails.loc[roads_trails.ASSET=='FOOT TRAIL'].copy()

# County boundaries in New York state (Polygon)
counties = gpd.read_file("/home/sungil/dataset/archive/NY_county_boundaries/NY_county_boundaries/NY_county_boundaries.shp")
```
...
```{python}
world_loans = gpd.read_file("/home/sungil/dataset/archive/kiva_loans/kiva_loans/kiva_loans.shp")
world_loans.head()
```
...
PHL = gpd.read_file("/home/sungil/dataset/archive/Philippines_AL258.kml",driver = "KML")
PHL.head()
```
